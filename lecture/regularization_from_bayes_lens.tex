...
Also, examine the distribution $\density(\sigma_{\mathrm{grp}} \given \by)$ as an informal check of sensitivity to the prior. 
...
\pause
Note that, for $m = 0$ (i.e.\ no training data), we have 
\begin{equation*} \defineTightSpacing%
\begin{aligned}
