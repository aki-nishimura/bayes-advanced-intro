...
\sum_\permutation \log \likelihood\!\left(y_{\permutation(2)} \given y_{\permutation(1)}, \modelSymbol \right)
	= (n - 1)! \sum_{\testSampleIndex = 1}^n \log \likelihood\!\left(y_{\permutation(2)} \given y_\testSampleIndex, \modelSymbol \right),
\end{equation*}
and hence
\begin{equation*} \defineTightSpacing%
\frac{1}{n!} \sum_\permutation \log \likelihood(y_{\permutation(1)} \given \modelSymbol)
	= \frac{1}{n} \sum_{\testSampleIndex = 1}^n \log \likelihood(y_\testSampleIndex \given \modelSymbol).
\end{equation*}
\end{frame}
